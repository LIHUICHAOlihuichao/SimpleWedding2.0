...
export default class All extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            nowLocation:yy.location,
            selectLocation: (yy.location)?yy.location:'全部',
               
            shuju: [{ "site_id": 0, "site_name": "全部",site_image:""},],
    ...
    fetch('http://10.7.86.197:8080/shop/')
        ...
        .then((responseJson) => {
            this.setState({
                ...
                shuju: this.state.shuju.concat(responseJson.filter(item=>item.city_id==this.state.wzid))
            }, function () {

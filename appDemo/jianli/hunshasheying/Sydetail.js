...
export default class Sydetail extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            dianpu: yy.dpname,
            detail: [],
            //  require('../../tupian/shoucang1.png') : require('../../tupian/shoucang.png')}  
            isFavorite: false,
        ...
        return (
            ...
            fetch('http://10.7.86.197:8080/photo/')
                ...
                .then((responseJson) => {
                    this.setState({
                        sy: responseJson,
                        detail: _that.state.detail.concat(responseJson.filter(item => item.photo_id == _that.state.id)),
                    }, function () {
                ...
                <ScrollView>
                                        ...
                                        <View>
                                            <Text style={{
                                                ...
                                                <View>
                                                    ...
                                                    >{tab.city_name}{tab.site_name}</Text>
                                                </View>
                                            </Text>
                                        </View>
                                    </View>
                    ...
                    <View style={{
                        ...
                        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                            {
                                this.state.sy.filter(item => item.shop_name === this.state.dianpu).filter(item => item.photo_id !== this.state.id).map(tab => (
                                    <Text
                                        style={styles.kuang}
                                        onPress={() => {
                                    ...
                                    >
                                        ...
                                        <View>
                                            <Text style={styles.ktxt}>{tab.photo_name}</Text>
                                        </View>
                                    </Text>
                                ))
                            }
                        ...
                        onPress={() => {
                            ...
                            if(isFavorite==true){
                                puturl(
                                    ...
                                    'http://10.7.86.197:8080/user_photo_collect/updatephotocollect?user_id='+this.state.userId
                                )
                            }else{
                                puturl(
                                    {

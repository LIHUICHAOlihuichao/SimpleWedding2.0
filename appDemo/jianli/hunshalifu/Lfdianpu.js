...
export default class Lfdianpu extends Component {
    ...
    render() {
        ...
        let twoContent = (this.state.selectType === '全部') ?
            <ScrollView>
                ...
                >
                    {
                        this.state.lf.filter(item => item.shop_name === this.state.dpname).map(tab => (
                            <Text
                                style={styles.spk}
                                onPress={() => {
            ...
            <ScrollView>
                ...
                >
                    {
                        this.state.lf.filter(item => item.shop_name === this.state.dpname).filter(item => item.style_name == this.state.selectType).map(tab => (
                            <Text
                                style={styles.spk}
                                onPress={() => {
                                    this.props.navigation.navigate('lfdetail', {

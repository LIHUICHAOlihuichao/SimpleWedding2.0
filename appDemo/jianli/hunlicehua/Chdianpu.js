...
export default class Chdianpu extends Component {
    ...
    componentDidMount() {
        ...
        return (
            ...
            fetch('http://10.7.86.197:8080/shop/')
                ...
                .then((responseJson) => {
                    this.setState({
                        sp: responseJson.filter(item => item.shop_typeid == 3),
                    }, function () {
    ...
    render() {
        ...
        let twoContent = (this.state.selectType === '全部') ?
            <ScrollView>
                ...
                >
                    {
                        this.state.ch.filter(item => item.shop_name == this.state.dpname).map(tab => (
                            <Text
                                style={styles.spk}
                                onPress={() => {
            ...
            <ScrollView>
                ...
                >
                    {
                        this.state.ch.filter(item => item.shop_name === this.state.dpname).filter(item => item.style_name == this.state.selectType).map(tab => (
                            <Text
                                style={styles.spk}
                                onPress={() => {
                                    this.props.navigation.navigate('chdetail', {

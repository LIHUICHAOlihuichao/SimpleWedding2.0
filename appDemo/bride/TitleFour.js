...
const TitleFour = ({ navigation,route}) => {
        ...
        <ScrollView style={styles.container}>
            <View>
                <View style={{height:ptd(180)}}>
                     <ImageBackground 
                        source={require('../brideImage/tit3.png')} 
                    ...
                    >
                        ...
                        <Text style={{color:'white',fontSize:ptd(18),marginLeft:ptd(15),marginTop:ptd(20)}}># 婚房布置攻略</Text>
                        <Text style={{color:'white',fontSize:ptd(14),marginLeft:ptd(15),marginTop:ptd(3)}}>拒绝土low,</Text>
                        <Text style={{color:'white',fontSize:ptd(14),marginLeft:ptd(10),marginTop:ptd(3)}}>婚房这样布置超好看</Text>
                    </ImageBackground>
                </View>

...
const TitleOne = ({ navigation,route}) => {
            ...
            <View>
                <View style={{height:ptd(180)}}>
                    ...
                    >
                        ...
                        <Text style={{color:'white',fontSize:ptd(17),marginLeft:ptd(5),marginTop:ptd(40)}}>#大婚倒计时查漏补缺</Text>
                        <Text style={{color:'white',fontSize:ptd(17),marginLeft:ptd(300),marginTop:ptd(5)}}>Are you Ready?!</Text>
                    </ImageBackground>
                </View>

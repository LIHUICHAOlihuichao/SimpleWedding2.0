...
const TitleThree = ({ navigation,route}) => {
        ...
        <ScrollView style={styles.container}>
            <View>
                <View style={{height:ptd(180)}}>
                     <ImageBackground 
                        source={require('../brideImage/tit2.jpg')} 
                    ...
                    >
                        ...
                        <Text style={{color:'white',fontSize:ptd(18),marginLeft:ptd(10),marginTop:ptd(10)}}>#婚礼誓词模板</Text>
                        <Text style={{color:'white',fontSize:ptd(14),marginLeft:ptd(10),marginTop:ptd(5)}}>💓想在婚礼这一天认认真真表达对于婚姻的憧憬和期待，表达对另一半的爱，也表达对父母的感恩👨‍👩‍👧‍👦。</Text>
                    </ImageBackground>
                </View>

    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#F5F5F5' }}>
            ...
            <Image
                style={styles.game1}
                source={
                    require('../images/game1_1.jpg')
                }
            />
            <Text style={styles.title}>接亲游戏 |  奶油打脸砸派机</Text>
            <Text style={[styles.title,{fontSize:18,marginTop:ptd(25)}]}>游戏道具：</Text>
            <Text style={[styles.title,{fontSize:18,marginTop:ptd(5)}]}>双人奶油打脸砸派机</Text>
...
export default connect(stateToProps, dispatchToProps)(JieqinContent);
